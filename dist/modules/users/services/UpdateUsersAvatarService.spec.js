...
var FakeStorageProvider_1 = __importDefault(require("@shared/container/providers/StorageContainer/fakes/FakeStorageProvider"));
var UpdateUsersAvatarService_1 = __importDefault(require("./UpdateUsersAvatarService"));
...
describe('UpdateAvatar', function () {
    it('should not be able to update avatar from non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeStorageProvider, updateAvatar;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUserRepository_1.default();
                    fakeStorageProvider = new FakeStorageProvider_1.default();
                    updateAvatar = new UpdateUsersAvatarService_1.default(fakeUsersRepository, fakeStorageProvider);
                    return [4 /*yield*/, expect(updateAvatar.execute({
    ...
    it('should not be able to avatar update.', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeStorageProvider, updateAvatar, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUserRepository_1.default();
    ...
    it('should delete old avatar when updating new one', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeStorageProvider, updateAvatar, deleteFile, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUserRepository_1.default();
