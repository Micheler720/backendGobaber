...
var UpdateUsersAvatarService = /** @class */ (function () {
    function UpdateUsersAvatarService(usersRepository, storageProvider) {
    ...
    UpdateUsersAvatarService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('UsersInject')),
        __param(1, tsyringe_1.inject('DiskStorage')),
