...
var fakeUserTokensRepotory;
var sendForgotPasswordEmail;
describe('ForgotEmailPassword', function () {
    beforeEach(function () {
        fakeMailProvider = new FakeMailProvider_1.default();
        fakeUserRepository = new FakeUserRepository_1.default();
        fakeUserTokensRepotory = new FakeUsersTokenRepository_1.default();
        sendForgotPasswordEmail = new SendForgotPasswordEmailService_1.default(fakeUserRepository, fakeMailProvider, fakeUserTokensRepotory);
    });
    ...
    it('should generate forgot password token.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generateToken = jest.spyOn(fakeUserTokensRepotory, 'generate');
                    return [4 /*yield*/, fakeUserRepository.create({
                            email: 'micheler720@gmail.com',
                            name: 'Michele',
                            password: '1234560',
