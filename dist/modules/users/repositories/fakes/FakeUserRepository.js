...
var FakeUsersRepository = /** @class */ (function () {
    ...
    FakeUsersRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                findIndex = this.users.findIndex(function (userFind) { return user.id === userFind.id; });
    ...
    FakeUsersRepository.prototype.FindByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var findUser;
            return __generator(this, function (_a) {
                findUser = this.users.find(function (user) { return email === user.email; });
    ...
    FakeUsersRepository.prototype.FindById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.users.find(function (user) { return user.id === id; })];
                    case 1:
                        findUser = _a.sent();
                        return [2 /*return*/, findUser];
                }
