...
var CreateAppointmentService = /** @class */ (function () {
    function CreateAppointmentService(appointsmentRepository) {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findApponitmentInSameDate, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentDate = date_fns_1.startOfHour(date);
                        return [4 /*yield*/, this.appointsmentRepository.findByDate(appointmentDate)];
                    case 1:
                        findApponitmentInSameDate = _b.sent();
                        if (findApponitmentInSameDate) {
                            throw new AppError_1.default('This appointment is already booked');
                        }
                        return [4 /*yield*/, this.appointsmentRepository.create({
