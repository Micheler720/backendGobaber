...
var AppointmentsController = /** @class */ (function () {
    ...
    AppointmentsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, provider_id, date, parsetDate, createService, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, provider_id = _a.provider_id, date = _a.date;
                        parsetDate = date_fns_1.parseISO(date);
                        createService = tsyringe_1.container.resolve(CreateAppointmentService_1.default);
                        return [4 /*yield*/, createService.execute({
