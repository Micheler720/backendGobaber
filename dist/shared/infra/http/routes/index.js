...
var appointmants_routes_1 = __importDefault(require("@modules/appointments/infra/http/routes/appointmants.routes"));
...
routes.use('/appointments', appointmants_routes_1.default);
